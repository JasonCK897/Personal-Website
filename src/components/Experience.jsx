    ...
    <section id="experience" className="py-12 sm:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="section-box p-8 sm:p-12 lg:p-14">
          ...
          <div className="relative border-l-2 border-slate-200 dark:border-slate-800 ml-4 md:ml-6 pl-6 md:pl-10 space-y-8">
            {experienceData.map((exp) => (
              <div key={exp.id} className="relative group">
                
                {/* Glowing Node Point */}
                <div className="absolute -left-[31px] md:-left-[47px] top-2 w-4 h-4 rounded-full bg-brand-blue dark:bg-sky-400 border-4 border-white dark:border-slate-900 shadow-md group-hover:scale-125 transition-transform duration-200"></div>
